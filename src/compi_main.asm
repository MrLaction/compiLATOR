;compi_main.asm — compiler driver: entry point of bin/compi
;
;CLI for the LATOR pipeline. Validates the .lator extension, opens the
;file and dup2's it onto stdin so the lexer reads it, then runs
;parse_program ("syntax OK") and, unless -s was given, sem_walk
;("semantic OK"). -v is reserved for the AST dump. Exit codes: 0 OK,
;1 usage/syntax, 2 semantic.
;
;Imports: parse_program (parser.asm), sem_walk (semantic.asm).

;lexer.asm — stage 1: lexical analyzer for the LATOR language
;
;Hand-written scanner over raw bytes from fd 0. Recognizes the 42 LATOR
;token kinds: keywords, identifiers, integer/float/string literals,
;operators, newlines, and "--" comments (discarded). One-character
;putback buffer; lexemes are NUL-terminated and capped at 255 bytes.
;
;Exports:

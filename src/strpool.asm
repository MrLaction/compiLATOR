;strpool.asm — interned lexeme storage for the LATOR front end
;
;Copies NUL-terminated lexemes into a fixed 64 KB pool and returns a
;stable pointer (intern_str); exhaustion exits with code 98. AST nodes
;reference these pointers instead of the volatile lexeme[] buffer.
;
;Exports: intern_str, str_pool.

;symbol_table.asm — stage 1 string data shared across the compiler
;
;Read-only tables for the LATOR lexer and its drivers: keyword strings
;(kw_*) matched by get_token, the token-name table (tk_name_table)
;indexed by token ID, and the fixed strings used by the token dump.
;Pure data; no code.

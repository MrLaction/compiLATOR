; semantic.asm — AST walker and semantic checker
; Traverses the AST produced by parser.asm and enforces:
;   1. No undeclared identifiers (in RHS / filter context)
;   2. No redeclarations
;   3. No type mismatches in comparisons
